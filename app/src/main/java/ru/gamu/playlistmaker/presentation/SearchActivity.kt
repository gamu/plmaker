...
import ru.gamu.playlistmaker.presentation.viewholder.tracklist.TrackListAdapter
...
class SearchActivity : AppCompatActivity() {
    ...
    private val tracksService by lazy { createTracklistService(this.applicationContext) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //tracksService = TrackListRepository(searchReader, historyWriter, historyReader)
